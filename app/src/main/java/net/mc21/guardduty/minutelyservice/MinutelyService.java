...
import net.mc21.guardduty.calls.AbstractCallActivity;
import net.mc21.guardduty.calls.CallActivity;
import net.mc21.guardduty.common.AttendanceCheckHelpers;
...
import net.mc21.guardduty.common.WakeLockManager;
import net.mc21.guardduty.calls.LoginRemindActivity;
import net.mc21.guardduty.internet.requests.UpdateSettingsRequest;
