...
import net.mc21.guardduty.internet.requests.AcquireWorkersRequest;
import net.mc21.guardduty.internet.requests.WorkerLoginRequest;
import net.mc21.guardduty.internet.interfaces.AcquireWorkersListener;
import net.mc21.guardduty.internet.interfaces.WorkerLoginListener;
