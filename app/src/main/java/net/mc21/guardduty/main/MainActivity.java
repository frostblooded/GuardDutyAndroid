...
import net.mc21.guardduty.internet.interfaces.WorkerLogoutListener;
import net.mc21.guardduty.internet.requests.WorkerLogoutRequest;
import net.mc21.guardduty.minutelyservice.MinutelyService;
